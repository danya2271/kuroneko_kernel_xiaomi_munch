					...
					size_t count, loff_t *ppos)
{
	...
	if (!err && oom_score_adj >= 700) {
		if (!strcmp(task_comm, "android:Metrica") ||
			!strcmp(task_comm, "ru.nspk.mirpay") ||
			!strcmp(task_comm, "org.lineageos.settings") ||
			!strcmp(task_comm, "com.wildberries.ru") ||
		    !strcmp(task_comm, "com.twofasapp")) {
